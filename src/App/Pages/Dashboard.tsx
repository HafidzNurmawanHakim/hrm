               ...
               <div className="flex gap-2">
                  <div className="w-60 flex flex-col 3xl:w-72">
                     <MiniCard
                        ...
                        icon={
                           <CalendarIcon className="text-secondary text-3xl" />
                        }
                        type="date"
                     ...
                     <MiniCard
                        ...
                        icon={
                           <InboxStackIcon className="text-secondary text-3xl" />
                        }
                     />
                     <MiniCard
                        desc="312 Total Tasks"
                        icon={
                           <ClipBoardTask className="text-secondary text-3xl" />
                        }
                     />
                     <MiniCard
                        desc="96 Active Employees"
                        icon={
                           <TwoUsersIcon className="text-secondary text-3xl" />
                        }
                     />
                  </div>
                  <div className="flex-auto rounded-xl bg-foreground text-fontBase">
