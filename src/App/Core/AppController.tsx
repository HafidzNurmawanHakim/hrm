...
const AppContext = createContext<AppContextProps | undefined>(initThemeContextProps);
...
const AppControllerProvider: FC<AppProviderProps> = ({ children }) => {
   ...
   function themeToggle() {
      ...
      toggleClassToBody();
      setValueToLocalStorage(isDarkTheme ? false : true);
   }
   ...
   function setValueToLocalStorage(boolean: boolean) {
      localStorage.setItem("isDarkTheme", `${boolean}`);
   }
