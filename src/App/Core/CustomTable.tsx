...
import TableEmptyContent from "./Atoms/TableEmptyContent";
...
const CustomTable: FC<TableProviderProps> = ({ children, columns, data }) => {
   ...
   const classNames = useMemo(
      () => ({
         wrapper: ["max-h-[382px]", "max-w-3xl bg-white shadow-none"],
