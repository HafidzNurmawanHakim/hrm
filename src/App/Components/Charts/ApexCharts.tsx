...
import QuadSquareIcon from "../../../Assets/Icons/QuadSquareIcon";
   ...
   return (
      <div className="">
         <div className="flex justify-between mx-6">
            ...
            <Button size="sm" isIconOnly className="border-secondary" variant="ghost">
               <QuadSquareIcon className="text-secondary text-2xl" />
            </Button>
         </div>
         <Chart type="area" options={options} series={series} height={300} width={width} />
      </div>
   );
};
