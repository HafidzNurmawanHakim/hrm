...
import MenuItem from "../Core/Atoms/MenuItem";
import MenuWithSubItem from "../Core/Atoms/MenuWithSubItem";
...
const SidePanel = () => {
   ...
   return (
      <div className="flex">
         <div
            className="flex h-screen w-16 flex-col justify-between bg-white"
         ...
         <div
            className={`flex h-screen flex-1 flex-col justify-between bg-white overflow-hidden transition-all duration-300 relative ${
               holdOn || showPanel ? "max-w-[300px]" : "max-w-[0px]"
            }`}
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
         >
